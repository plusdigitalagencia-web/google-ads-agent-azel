#!/usr/bin/env python3
"""
KG Clinica y Salud - Relatorio Semanal Meta Ads (7 Modulos)
SOP: data-know/SOP-analise-meta-ads.md
Conta: act_375804741111201 | Moeda: EUR | Barcelona, Espanha
Roda toda segunda via GitHub Actions as 07:10 BRT
Token: KG_CLINICA_META_TOKEN | Expira: verificar na conta
"""
import os, urllib.request, urllib.error, urllib.parse
import json, datetime, base64, time

TOKEN        = os.environ["KG_CLINICA_META_TOKEN"]
GITHUB_TOKEN = os.environ["GH_PAT"]
ACCOUNT      = "act_375804741111201"
...
report   = "
".join(L)
filepath = f"reports/data-know/kg-clinica/meta-report-{today.strftime('%Y-%m-%d')}.md"
...
save_to_github(filepath, report, f"feat: relatorio Meta Ads KG Clinica {today.strftime('%Y-%m-%d')}")
