#!/usr/bin/env python3
"""
Luxe Icon LTD (RC Bag Marketplace) - Relatorio Semanal Meta Ads (7 Modulos)
SOP: data-know/SOP-analise-meta-ads.md
Conta: act_412122005210742 | Moeda: EUR | Budget: EUR3000/mes
...
report   = "\n".join(L)
filepath = f"reports/data-know/luxe-icon/meta-report-{today.strftime('%Y-%m-%d')}.md"
...
save_to_github(filepath, report, f"feat: relatorio Meta Ads Luxe Icon {today.strftime('%Y-%m-%d')}")
