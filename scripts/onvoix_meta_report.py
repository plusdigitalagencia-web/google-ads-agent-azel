#!/usr/bin/env python3
"""
Onvoix - Relatorio Semanal Meta Ads com Claude AI
Conta: act_1297650828540575 | Moeda: USD | Budget: $500/mes
...
save_to_github(filepath, report, f"feat: relatorio Meta Ads Onvoix {today.strftime('%Y-%m-%d')} (Claude AI)")
