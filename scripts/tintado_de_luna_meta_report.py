#!/usr/bin/env python3
"""
Tintado de Luna - Relatorio Semanal Meta Ads (7 Modulos)
SOP: data-know/SOP-analise-meta-ads.md
Conta: act_9709425065783957 | Moeda: EUR | Madrid, Espanha
Roda toda segunda via GitHub Actions as 07:10 BRT
Token: TINTADO_LUNA_META_TOKEN | Expira: verificar na conta
"""
import os, urllib.request, urllib.error, urllib.parse
import json, datetime, base64, time

TOKEN        = os.environ["TINTADO_LUNA_META_TOKEN"]
GITHUB_TOKEN = os.environ["GH_PAT"]
ACCOUNT      = "act_9709425065783957"
BASE         = "https://graph.facebook.com/v25.0"
GITHUB_REPO  = "plusdigitalagencia-web/google-ads-agent-azel"
CLIENT_NAME  = "Tintado de Luna"
CURRENCY     = "€"
...
save_to_github(filepath, report, f"feat: relatorio Meta Ads Tintado de Luna {today.strftime('%Y-%m-%d')}")
