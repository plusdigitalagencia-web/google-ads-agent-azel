#!/usr/bin/env python3
"""
Dispatcher — Relatórios Segunda-feira
Aciona todos os relatórios Meta Ads semanais via workflow_dispatch.
Chamado pelo dispatcher-segunda.yml toda segunda às 06:50 BRT.
"""
import os
import json
import time
...
print("=== Dispatcher Segunda-feira ===\n")
erros = []
